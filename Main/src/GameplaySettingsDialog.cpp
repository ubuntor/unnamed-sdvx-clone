...
void GameplaySettingsDialog::InitTabs()
{
    ...
    offsetTab->settings.push_back(CreateIntSetting(GameConfigKeys::VisualOffset, "Visual Offset", {-200, 200}));
    offsetTab->settings.push_back(CreateIntSetting(GameConfigKeys::InputOffset, "Input Offset", {-200, 200}));
    offsetTab->settings.push_back(CreateIntSetting(GameConfigKeys::AudioOffset, "Audio Offset", {-200, 200}));
